...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_ALPHA] = LAYOUT_WHTK(
        KC_NO,         KC_NO,         KC_GRV,        KC_EQL,        KC_MINS,       KC_SLSH_BSLS,  KC_QUOT,       KC_DOT_COMM,   KC_EXLM_QUES,  KC_SCLN,       KC_NO,         KC_INS,
        MACRO_1_PLAY,  KC_Q,          KC_W,          KC_E,          KC_R,          KC_T,          KC_Y,          KC_U,          KC_I,          KC_O,          KC_P,          KC_PSCR,
        MACRO_2_PLAY,  KC_A,          KC_S,          KC_D,          KC_F,          KC_G,          KC_H,          KC_J,          KC_K,          KC_L,          KC_ESC,        KC_SLCK,
        KC_LALT,       KC_LSFT,       KC_Z,          KC_X,          KC_C,          KC_V,          KC_B,          KC_N,          KC_M,          KC_DEL,        KC_RCTL,       KC_PAUS,
                                      KC_DEL,        KC_ENT,                                                                    NORMAL_MODE,   MAC_MODE,
                                                                    KC_THUMB_L1,   KC_THUMB_L0,   KC_THUMB_R0,   KC_THUMB_R1,
                                                                    KC_LGUI,       MO(_FUNC),     MO(_NUMERIC),  MO(_FUNC),
                                                                    LSFT(KC_LGUI), MO(_NUMERIC),  MO(_UMLAUT),   KC_RALT
    ),
    [_FUNC] = LAYOUT_WHTK(
        DYN_REC_STOP,  KC_NO,         KC_AT,         KC_LT,         KC_GT,         KC_CIRC,       KC_MS_L,       KC_MS_D,       KC_MS_U,       KC_MS_R,       KC_BTN1,       KC_BTN2,
        MACRO_1_REC,   KC_NO,         KC_HASH,       KC_LCBR,       KC_RCBR,       KC_ASTR,       KC_PREV_WORD,  KC_HOME,       KC_END,        KC_NEXT_WORD,  KC_BTN3,       KC_NO,
        MACRO_2_REC,   KC_NO,         KC_DLR,        KC_LPRN,       KC_RPRN,       KC_AMPR,       KC_LEFT,       KC_DOWN,       KC_UP,         KC_RGHT,       KC_TRNS,       KC_NO,
        KC_TRNS,       KC_TRNS,       KC_PERC,       KC_LBRC,       KC_RBRC,       KC_PIPE,       KC_PREV_TAB,   KC_PGDN,       KC_PGUP,       KC_NEXT_TAB,  KC_TRNS,       RESET,
...
bool process_record_user_mac_mode(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        KC_MAP(MO(_UMLAUT), LALT(KC_U))  // mac umlaut leader
